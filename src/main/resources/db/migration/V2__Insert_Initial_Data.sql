...
INSERT INTO tbl_product_variant (product_id, color, size, stock) VALUES
(@product_id, '그레이', 'M', 100),
(@product_id, '그레이', 'L', 100),
(@product_id, '그레이', 'XL', 100);
...
SET @product_id = LAST_INSERT_ID();
INSERT INTO tbl_product_variant (product_id, color, size, stock) VALUES
(@product_id, '화이트', 'M', 100),
(@product_id, '화이트', 'L', 100),
(@product_id, '화이트', 'XL', 100);
...
SET @product_id = LAST_INSERT_ID();
INSERT INTO tbl_product_variant (product_id, color, size, stock) VALUES
(@product_id, '네이비', 'M', 100),
(@product_id, '네이비', 'L', 100),
(@product_id, '네이비', 'XL', 100);
